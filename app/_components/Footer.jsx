		...
		<footer className="mt-32 bg-gray-100">
			<div className="max-w-5xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
				...
				<ul className="flex flex-wrap justify-center gap-6 mt-12 md:gap-8 lg:gap-12">
					...
					<li>
						<a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Products </a>
					</li>

					<li>
						<a className="text-gray-700 transition hover:text-gray-700/75" href="/"> AboutUs </a>
					</li>

					<li>
						<a className="text-gray-700 transition hover:text-gray-700/75" href="/"> ContactUs </a>
					</li>
				</ul>
